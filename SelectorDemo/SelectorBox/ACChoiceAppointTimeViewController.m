//
//  ACChoiceAppointTimeViewController.m
//  SelectorDemo
//
...
- (ACChoiceAppointTimeHeadView *)headView {
    if (!_headView) {
        self.headView = [[ACChoiceAppointTimeHeadView alloc] initWithFrame:(CGRectMake(0, [UIScreen mainScreen].bounds.size.height - kHeadheight - kRowHeight*kRowNum, [UIScreen mainScreen].bounds.size.width, 42))];
...
- (ACChoiceAppointTimeListView *)dayListView {
    if (!_dayListView) {
        self.dayListView = [[ACChoiceAppointTimeListView alloc] initWithFrame:(CGRectMake(0, [UIScreen mainScreen].bounds.size.height - kRowHeight*kRowNum, kDayWidth, kRowHeight*kRowNum)) viewType:ACChoiceAppointTimeView_Day];
...
- (ACChoiceAppointTimeListView *)timeListView {
    if (!_timeListView) {
        self.timeListView = [[ACChoiceAppointTimeListView alloc] initWithFrame:(CGRectMake(kDayWidth, [UIScreen mainScreen].bounds.size.height - kRowHeight*kRowNum, [UIScreen mainScreen].bounds.size.width - kDayWidth, kRowHeight*kRowNum)) viewType:ACChoiceAppointTimeView_time];
