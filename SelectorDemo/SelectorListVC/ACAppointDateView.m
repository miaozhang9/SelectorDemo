...
- (instancetype)initWithFrame:(CGRect)frame{
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = [UIColor pc_colorWithHexString:@"#EEEEEE"];
...
- (void)initAndModifySubviews {
    ...
    gradient.colors = [NSArray arrayWithObjects:
                       (__bridge id)[UIColor pc_colorWithHexString:@"#3F43E0"].CGColor,
                       (__bridge id)[UIColor pc_colorWithHexString:@"#643EF2"].CGColor,
                       nil];
    //设置颜色分割点（范围：0-1）
...
- (void)defaultState {
    ...
    _titleLb.textColor = [UIColor pc_colorWithHexString:@"#999999"];
    _describeLb.textColor = [UIColor pc_colorWithHexString:@"#999999"];
}
