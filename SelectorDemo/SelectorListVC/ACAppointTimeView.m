...
- (void)updateAppointItem:(ACAvailableDTO *)dto  {
    ...
    if (dto.availablecount.integerValue <= 10) {
        _describeNumView.hidden = NO;
        _describeNumView.numLb.text = [NSString stringWithFormat:@"%ld", dto.availablecount.integerValue];
    } else {
...
- (void)capableAppointState {
    ...
    [_appointButton setTitleColor:[UIColor pc_colorWithHexString:@"#2363FF"] forState:UIControlStateNormal];
    //    [_appointButton setTitle:@"预约" forState:UIControlStateNormal];
    _appointButton.layer.borderColor = [UIColor pc_colorWithHexString:@"#2363FF"].CGColor;
}

- (void)unCapableAppointState {
    _appointButton.enabled = NO;
    _appointButton.backgroundColor = [UIColor pc_colorWithHexString:@"#EEEEEE"];
    [_appointButton setTitleColor:[UIColor pc_colorWithHexString:@"#999999"] forState:UIControlStateNormal];
    //    [_appointButton setTitle:@"已满" forState:UIControlStateNormal];
    _appointButton.layer.borderColor = [UIColor pc_colorWithHexString:@"#EEEEEE"].CGColor;
}
...
- (UIView *)lineView {
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [UIColor pc_colorWithHexString:@"#D8D8D8"];
    }
    return _lineView;
}
...
- (UILabel *)leftLb {
    if (!_leftLb) {
        ...
        _leftLb.textColor = [UIColor pc_colorWithHexString:@"#999999"];
...
- (UILabel *)numLb {
    if (!_numLb) {
        ...
        _numLb.backgroundColor = [UIColor pc_colorWithHexString:@"#FF991D"];
...
- (UILabel *)rightLb {
    if (!_rightLb) {
        ...
        _rightLb.textColor = [UIColor pc_colorWithHexString:@"#999999"];
